...
export default function SmallCard({ title, description, icon, accentColor }) {
    ...
    if (accentColor === "red") {
        ...
        iconClass = "text-blue-500 text-3xl";
    } else if (accentColor === "green") {
        iconClass = "text-green-500 text-3xl";
    } else if (accentColor === "yellow") {
        iconClass = "text-yellow-500 text-3xl";
    } else if (accentColor === "purple") {
        iconClass = "text-purple-500 text-3xl";
    } else if (accentColor === "pink") {
        iconClass = "text-pink-500 text-3xl";
    } else if (accentColor === "indigo") {
        iconClass = "text-indigo-500 text-3xl";
    } else if (accentColor === "gray") {
        iconClass = "text-gray-500 text-3xl";
    } else if (accentColor === "black") {
        iconClass = "text-black text-3xl";
    } else if (accentColor === "white") {
        iconClass = "text-white text-3xl";
    } else if (accentColor === "rose") {
        iconClass = "text-rose-500 text-3xl";
    }


    return (
        <div className="bg-black border-2 rounded-md border-neutral-800 p-6 relative space-y-3">
