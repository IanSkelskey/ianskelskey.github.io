  ...
  return (
    ...
    >
      <motion.div className="not-found-content" variants={itemFadeIn(0)}>
        <motion.h1 className="not-found-title" variants={itemFadeIn(1)}>
          404
        </motion.h1>
        <motion.div
        ...
        ></motion.div>
        <motion.h2 className="not-found-subtitle" variants={itemFadeIn(3)}>
          Page Not Found
        </motion.h2>
      ...
      <motion.div className="not-found-decoration" variants={itemFadeIn(6)}>
        <div className="not-found-code-block">
          <motion.div className="code-line" variants={itemFadeIn(7)}>
            <span className="code-keyword">const</span>{" "}
            <span className="code-variable">page</span> ={" "}
            <span className="code-string">'awesome'</span>;
          </motion.div>
          <motion.div className="code-line" variants={itemFadeIn(8)}>
            <span className="code-keyword">try</span> {"{"}
          </motion.div>
          <motion.div className="code-line indent" variants={itemFadeIn(9)}>
            <span className="code-keyword">if</span> (page !=={" "}
            <span className="code-string">'found'</span>) {"{"}
          </motion.div>
          <motion.div
          ...
          >
            ...
            <span className="code-string">'404'</span>);
          </motion.div>
          <motion.div className="code-line indent" variants={itemFadeIn(11)}>
            {"}"}
          </motion.div>
          <motion.div className="code-line" variants={itemFadeIn(12)}>
            {"}"} <span className="code-keyword">catch</span> (error) {"{"}
          </motion.div>
          <motion.div className="code-line indent" variants={itemFadeIn(13)}>
          ...
          <motion.div className="code-line" variants={itemFadeIn(14)}>
            {"}"}
          </motion.div>
        </div>
      </motion.div>
