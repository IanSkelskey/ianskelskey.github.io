      ...
      if (foundSkill) {
        ...
        const matchingProjects = projects.filter(
          (project) =>
            ...
            project.skills.some(
              (projectSkill) =>
                projectSkill.toLowerCase() === skillName.toLowerCase(),
            ),
        );
  ...
  return (
    ...
    >
      <motion.section
        ...
        animate="visible"
      >
        <motion.h2 variants={itemFadeIn(0)}>
        ...
        {relatedProjects.length === 0 ? (
          ...
          >
            {relatedProjects.map((project, index) => (
              <ProjectCard key={project.path} project={project} index={index} />
            ))}
          </motion.div>
        )}
      </motion.section>
      ...
      <motion.div variants={itemFadeIn(0)} initial="hidden" animate="visible">
        <CTASection
